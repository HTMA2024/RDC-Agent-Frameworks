---
name: rdc-analyst
description: Public main skill for the RenderDoc/RDC render analysis framework. Use when the user wants to analyze a capture's rendering pipeline, reverse-engineer shaders, track resources, or build render knowledge from .rdc captures.
metadata:
  short-description: RenderDoc/RDC render pipeline analysis for .rdc captures
---
